            ...
            <PopoverContent className="w-56 p-1" align="end">
                <div className="grid gap-0.5">
                    ...
                    <Link href="/resume-tailor">
                        <Button variant="ghost" size="sm" className="w-full justify-start h-8 px-2 text-sm font-normal">
                            <MagicWand size={16} className="mr-2" /> Resume Tailor
                        </Button>
                    </Link>
                    ...
                    {user ? (
                        ...
                        <Button
                            ...
                            onClick={() => {
                                // Close the menu is handled by UI interactions usually for links, 
                                // but for buttons triggering other things, we might want to ensure.
                                // But Radix Popover usually respects outside clicks.
                                onSignInClick();
                            }}
                        >
